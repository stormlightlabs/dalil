...
<main id="main-content" class="landing">
	<section class="landing-hero" aria-labelledby="landing-title">
		...
		<div class="landing-actions">
			...
			<a class="text-link" href={resolve('/docs/guides/default-briefing/')}>
				Read the guide <span class="i-ri-arrow-right-line" aria-hidden="true"></span>
			</a>
		</div>
...
&#123;
  ...
  "reading_plan": &#123;
    "recommendations": [
      &#123; "ordinal": 1, "purpose": "start_here", "path": "README.md" &#125;,
      &#123; "ordinal": 2, "purpose": "architecture", "path": "src/lib.rs" &#125;
    ]
  &#125;
&#125;
<span class="meta">… and more</span></code></pre>
		</figure>
	</section>
...
<style>
	...
	.terminal {
		...
		box-shadow: 0 24px 60px rgb(20 20 21 / 18%);
		color: var(--code-ink);
	}
