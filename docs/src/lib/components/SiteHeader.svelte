<script lang="ts">
	...
	const primaryLinks = [
		...
		{ label: 'Guides', href: '/docs/guides/default-briefing/', slug: 'guides' },
		{ label: 'Reference', href: '/docs/reference/manifests/', slug: 'reference' }
	] as const;
	const githubUrl = 'https://github.com/stormlightlabs/dalil';
...
<header class="site-header" data-pagefind-ignore>
	<div class="header-inner">
		<a class="brand" href={resolve('/')} aria-label="Dalil documentation home">
